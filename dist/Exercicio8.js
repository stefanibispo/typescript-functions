...
//Opção1 de código
const calcularMontanteInvestimento = (capitalInicial, tempoDoInvestimentoMeses, taxaJurosMensal) => parseFloat((capitalInicial * Math.pow(1 + taxaJurosMensal / 100, tempoDoInvestimentoMeses)).toFixed(2));
...
//Opção2 de código
function calcularMontanteInvestimento2(capitalInicial, tempoDoInvestimentoMeses, taxaJurosMensal) {
